class Notification < ApplicationRecord
  ...
  def broadcast_to_recipient
    ...
    broadcast_prepend_to "notifications_#{recipient_id}", target: "notifications_list", partial: "notifications/notification", locals: { notification: self, viewer: recipient }
  end
end
