...
# Crear catálogo de agentes aduanales broker (personas con patente)
puts "Creando catálogo de agentes aduanales broker (personas con patente)..."
...
customs_agents_with_patents_data.each do |name, patent_number|
  ...
  entity.name = name
  entity.role_kind = "customs_broker"
  entity.patent_number = patent_number
  entity.save! if entity.new_record? || entity.changed?
end

puts "✓ Agentes aduanales broker (personas con patente) cargados: #{customs_agents_with_patents_data.size}"

# Crear catálogo de agencias aduanales (entidades)
puts "Creando catálogo de agencias aduanales..."

customs_agencies_data_raw = <<~AGENCIES
  DICEX
  ASESORES DE INTERCAMBIO ADUANERO
  SISTEMAS FRACTAL
  JABIL CIRCUIT DE MEXICO S DE RL DE CV
  CASSO TRANSLINE
  ALMEIDA Y ALATORRE S.C.
  AGENCIA ADUANAL AZTECA
  BENQ
  GTS CORPORATIVO ADUANERO SC
  LTS AGENCIA ADUANAL
  KROM SEA PORTS
  EXPEDITORS INTERNACIONAL DE MEXICO SA DE CV
  GRUPO INTERMEDIACION ESTRATEGICA EN COMERCIO EXTERIOR GRUPO INECEX SC
  GOMSA INTEGRADORA SAPI DE CV
  INTEGRADORA ADUANAL Y DE SERVICIO WOODWARD. SC
  LOGIS SERVICIOS DE COMERCIO EXTERIOR
  ALMEIDA Y ALATORRE
  AGENCIA ADUANERA DE AMERICA LC
  CARGO Y LOGISTICA DEL CENTRO SA DE CV
  GOMSA INTEGRADORA SA PROMOTORA DE INVERSION DE CV
  PEDRO MARTINEZ MENDEZ Y CIA S.C
  CONSULTORIA DE LIBRE COMERCIO, SC
  WELLDEX INTERNACIONAL, SC
  DESPACHOS ADUANALES ALCANTARA SA DE CV
  ALIANZA ESTRATEGICA PORTUARIA
  ISCE AGENCIA ADUANAL, SC
  RETO COORDINADORA LOGISTICA PORTUARIA S.C
  FERNANDEZ HINOJOSA Y CIA SC
  CS CARGA FORWARDERS, SA DE CV
  UNI-TRADE BROKERS S.C
  RADAR CUSTOMS & LOGISTICS
  GRUPO SAN INTELIGENCIA ADUANAL S.C.
  OCAMPO GRUPO ADUANAL SA DE CV
  MIMPO SERVICIOS ADUANALES SA DE CV
  GOMEZ Y ALVEZ AGENCIA ADUANAL SC
  LEAN LOG SERVICES MEXICO SA DE CV
  GRUPO CARGOQUIN SA DE CV
  DOCUMENTADORES ADUANALES DEL PACIFICO SC
  VISA LOGISTICA ADUANERA SC
  GRUPO ADUANAL GALVAN SC
  GRUPO ADUANAL DEL VALLE SC
  PG LAZARO CARDENAS, S.C
  MURIS SALINAS CONSULTORES
  BORDER PENINSULAR, S.C
  OÑATE WILLY Y COMPAÑIA
  LEAN LOG SERVICES MEXICO S R L DE CV
  INTEGRADORA DE APOYOS AL COMERCIO EXTERIOR SA DE CV
  ENRIQUE RAMOS Y CIA
  OÑATE WILLY Y COMPAÑIA
  VILLANUEVA CERVANTES Y ASOCIADOS
  INTERTRAFFIC INTERNATIONAL S.C
  AGENCIA ADUANAL SORIANO Y ASOCIADOS, S.C.
  PDSA, SC
  AGENCIA ADUANAL PEREZ ORTIZ, S.C.
  AGENCIA ADUANAL JORGE DIAZ, S.C
  GRUPO EI LAZARO CARDENAS SC
  CORPORATIVO ENCISO
  G-GLOBAL, SA DE CV
  AGENCIA ADUANAL FERNANDEZ ESPINOSA, SC
  A J PALAZUELOS SC
  AGENCIA ADUANAL OBREGON, S.C.
  PRIDA SERVICIOS CORPORATIVOS
  MOZ SOLUCIONES INTEGRALES SA DE CV
  EXPEDITORS INTERNATIONAL DE MEXICO
  MEJIA Y SUCESORES
  CTI - ANDERE & NOGUEIRA GROUP
  COORDINADORA DE SERVICIOS ADUANALES ATLAS
  PRACTICA ADUANAL SC
  INTEGRACION ADUANAL, S.C.
  MARIO DAVID RUANOVA  ZARATE
  I TRANS SERVICIOS ADUANALES SA DE CV
  AGENCIA ADUANAL ULLOA SC
  PG DEL PACIFICO, S.C.
  DESPACHOS ADUANALES CASTAÑEDA SC
  INTEGRADORA DE APOYOS AL COMERCIO EXTERIOR SA DE CV
  INTERTRAFFIC INTERNATIONAL SC
  RIVYA CONSULTING GROUP S S RL DE CV
  BORDER PENINSULAR SC
  GRUPO ADUANAL OSCAR MAYER DEL NOROESTE, S.C.
  DESPACHOS ADUANALES INTEGRADOS DEL PACIFICO S.C.
  RADAR CUSTOMS & LOGISTICS
  CORPORACION ADUANAL RR
  AGENCIA ADUANAL ESQUER LUKEN, S.C.
  ECU WORLDWIDE MEXICO SA DE CV
  BARI IMPORTS SA DE CV
  GRUPO ORBEADUANA
  GRUPO ADUANAL SUSTAITA, S.C.
  MULTISERVICIOS ADUANALES DE MANZANILLO SC
  AGENCIA ADUANAL GUILLEMIN Y ASOCIADOS SA DE CV
  VILLANUEVA LORENZO AGENTES ADUANALES, S.C.
  CORPORACION ADUANAL Y SERVICIOS AL COMERCIO EXTERIOR SC
  MEJIA Y SUCESORES
  AGENCIA ADUANERA DE AMERICA DEL PACIFICO,S.C
  TRAMITES Y LOGISTICA EN COMERCIO EXTERIOR SA DE CV
  CORPORATIVO ADUANAL TRUJILLO Y ASOCIADOS SC
  GRUPO ADUANAL DEL PACIFICO
  SERVICIOS ADUANALES Y MANIOBRAS DE AEROCARGA SA DE CV
  DOCUMENTADORES ADUANALES DEL PACIFICO SC
  CORPORATIVO ADUANAL TRUJILLO Y ASOCIADOS SA DE CV
  ORGANIZACION ADUANAL SIGLO XXI
  NAD GLOBAL SA DE CV
  SERVICIOS ADUANALES Y LOGISTICA INTEGRAL ROBEJOMA SA DE RL DE CV
  AGENCIAS ADUANALES CONSOLIDADAS SC
  PALCO, CONSORCIO DE COMERCIO INTERNACIONAL, S.C.
  GRUPO EMPRESARIAL ADUANERO SC
  BUFETE MEXICANO DE ADUANAS SC
  JMM SERVICIOS ADUANALES SC
  CONSADINT SC
  LME AGENT
  ASESORIAS Y SERVICIOS ADUANEROS EN MANZANILLO, S.C.
  ROSA CAROLINA MACHADO LOPEZ
  TRALICOM LOGISTICS, SA DE CV
  AGENCIA ADUANAL GUSTAVO AVILA SC
  GRUPO ADUANAL GALVAN SC
  CORPORATIVO INTERNACIONAL ESPECIALIZADO SC
  ADHHER SOLUCIONES ADUANALES, SA DE CV
  COMEXTAA SC
  PLUSCARGO TRANSPORTE MEXICANA
  UNI-TRADE BROKERS,SC
  SERVICIOS Y LOGISTICA INTERNACIONAL ARL
  C & E AGENTES ADUANALES
  AGENTES ADUANALES GRUPO NOGUEIRA, SC
  ASESORES MULTINACIONALES SLI SA DE CV
  HANO PANIAGUA Y ASOCIADOS SC
  WWL COMMERCE AND SERVICES SC
  CORPORATIVO ADUANAL ROBLES
  D A HINOJOSA SA DE CV
  GRUPO CARGOQUIN
  CAM DEL PACIFICO, S.C
  GRUPO EI MANZANILLO SC
  TECNO LOGISTICA ADUANAL SA DE CV
  FH DEL PACIFICO SC
  HERNANDEZ BOLAÑOS Y ASOCIADOS; S.C.
  COMERCIO EXTERIOR MIRAL SC
  AGENCIA ADUANAL DEL RIO Y ASOCIADOS SC
  GRUPO ADUANAL FERCO, S.C.
  HANO PANIAGUA Y ASOCIADOS SC
  NAD INTERNATIONAL, SA DE CV
  CONDOR AIR SERVICIOS SC
  GRUPO BORDER, S.C.
  INTEGRADORA LOGISTICA FERNANDEZ SC
  OCAMPO GRUPO ADUANAL
  GRUPO GTS ADUANAS Y SERVICIOS SC
  ZBC, S.C
  PROEXI INTERNACIONAL DEL PACIFICO, S.C
  LOGISTICA 365, S DE RL DE CV
  DESPACHO ADUANAL DEL GOLFO, S.C.
  MORENO SESMA Y ASOCIADOS SC
  COORDINADORA Y DISEÑO EN SOLUCIONES DE COMERCIO EXTERIOR SA DE CV
  INTELIGENCIA EN COMERCIO EXTERIOR SC
  DIAZ DE VEGA, S.C
  VILLANUEVA CERVANTES Y ASOCIADOS, S.C
  Z Y F AGENCIA ADUANAL SC
  ARFERION SA DE CV
  AGENCIA ADUANAL INTERNACIONAL DE OCCIDENTE SC
  ECOMEX ESTRATEGAS EN COMERCIO EXTERIOR SC
  CONSORCIO ADUANAL SERVI PORT SC
  SERVICIOS LOGISTICOS GAVA SC
  AGENCIA ADUANAL GAMAS MANZANILLO SC
  VISA LOGISTICA ADUANERA SC
  MEDINA FORWARDING MEXICO,S.C.
  GRUPO ADUANAL SUSTAITA
  IAB LOGISTICA, S.C.
  CORPORATIVO LOGISTICO GEA, SA DE CV
  VICTOR SALINAS AGENTE ADUANAL, S.C.
  YARZA Y CIA S.C
  SILCA LOGISTICA AGENCIA ADUANAL SC
  OLIVA MUÑOZ CONSULTORES ADUANALES SC
  LOGIS SERVICIOS DE COMERCIO EXTERIOR
  SERVICIOS ADUANALES EXIMIN, S.C.
  GONZALEZ CASTILLO Y MEDINA, S.C
  AFS AGENCIA ADUANAL, S.C.
  GONZALEZ TORRES Y CIA SC
  MOVERS SOLUCIONES INTEGRALES, S.C.
  KROM SEA PORTS
  CABRERA LLAMAS Y ASOCIADOS SA DE CV
  AGENCIA ADUANAL WISE SICE SA DECV
  CORPORACION CASTA&EDA, S.C.
  GRUPO ILLINGWORTH LOGISTICS, SA DE CV
  LOGISTICA ADUANAL DEL PACIFICO, SC
  GIL Y GIL AGENTES ADUANALES
  AGENCIA ADUANAL PASCAL, SC
  LTP & ADAM AGENCIA ADUANAL SA DE CV
  KALISCH ALONSO AGENCIAS ADUANALES
  IBC LOGISTICS CORPORATIVO ADUANAL, S.C.
  AIR OCEAN AND LAND LOGISTIC
  G A RODRIGUEZ, S.C.
  MARCO A. SANSORES GARCES, S.C.
  DICEX SA DE CV
  RAVISA MEXICO, S.C.
  AGENCIA ADUANAL FERNANDEZ ESPINOSA SC
  VICTORIA AGENCIA DE DESPACHO ADUANAL SC
  EXCELENCIA EN LOGISTICA ADUANAL SC
  GRUPO HERNANDEZ GARZA. S.C
  ACG GRUPO ADUANAL SC
  MOZ AGENCIAS ADUANALES DE LAZARO CARDENAS SC
  INTEGRADORA DE SISTEMAS Y SERVICIOS ADUANALES SC
  CORPORATIVO ADUANAL ROI, S.C
  AGENCIA ADUANAL HERNANDEZ MARYM SC
  ADUALINK VMI SERVICES SA DE CV
  INTEGRADORA LOGISTICA FERNANDEZ, S.C.
  TRIMODAL DE MEXICO SC
  DIAZ DE VEGA SC
  ABJ LOGISTICA ADUANAL DE VERACRUZ
  LOSEN SA DE CV
  HUGO GALINDO Y ASOCIADOS
  JARB Y ASOCIADOS, S.C.
  GRUPO DE LOGISTICA ADUANERA, SC
  INTEGRADORA EN LOGISTICA ADUANAL ANSE, S.C.
  ENRIQUE RAMOS Y CIA SC
  INDUSTRIAS UNIDAS
  SOLUCIONES LOGISTICAS M&B SA DE CV
  SISTEMA ADUANAL PROFESIONAL SC
  HESSEN LOGISTICS Y ADUANAS, SC
  LOGISTICA CORPORATIVA EN COMERCIO EXTERIOR, SC
  ASIMEX ADUANAS, SA DE CV
  DEL BRAVO SL, SA DE CV
  GRUPO ADUANAL BARQUIN,SC
  GLOBAL AGENTES ADUANALES Y ASESORES EN COMERCIO EXTERIOR SC
  GRUPO ADUANAL PRIDA SA DE CV
  AGUILAR MORFIN SC
  GIMPS INTERNATIONAL SA DE CV
  GTS CORPORATIVO ADUANERO SC
  MVE CARGO LINE SC
  FENIX SERVICIOS ADUANALES SC
  ONE LOG,  SA DE CV
  GLAFIRO SALINAS MENDIOLA Y ASOCIADOS EN MANZANILLO, S.C.
  ESH LOGISTICA INTELIGENTE, S.C.
  ALIANZA ESTRATEGICA PORTUARIA SA DE CV
  CONDOR AIR SERVICIOS, S.C.
  A J PALAZUELOS SC
  INTEGRADORA LOGISTICA FERNANDEZ SC
  WA4 LOGISTICA, S.C.
  SERVICIOS LOGISTICOS INTERNACIONALES GUME, SA DE CV
  LOUNIKO TRADING CORPORATION, S.C.
  SERVICIO EXPRESS ADUANAL, SA DE CV
  LOSEN SA DE CV
  VICTORIA AGENCIA DE DESPACHO ADUANAL SC
  LOGISTICA WOODWARD SC
  VILLASANA DEL PACIFICO SA DE CV
  TCM ASESORIA EN COMERCIO EXTERIOR
  HESSEN LOGISTICS Y ADUANAS SC
  TRADELINK PACIFICO
  AGENCIA ADUANAL PEREZ ORTIZ
  TRALICOM LOGISTICS SA DE CV
  AGENCIA ADUANAL HODOYAN NAVARRO
  BENITO ABAD Y CIA SC
  MARTINEZ ITURRIAGA, S.C.
  TRADUS ADUANAL SC
AGENCIES

customs_agencies_data_unfiltered = customs_agencies_data_raw
  .split("\n")
  .map { |name| name.strip }
  .reject(&:blank?)

customs_agencies_data = customs_agencies_data_unfiltered.uniq
exact_duplicates_count = customs_agencies_data_unfiltered.size - customs_agencies_data.size
puts "Se omitieron #{exact_duplicates_count} duplicados exactos en agencias" if exact_duplicates_count.positive?

normalized_customs_agencies = customs_agencies_data.each_with_object({}) do |name, acc|
  normalized_key = ActiveSupport::Inflector.transliterate(name.to_s).upcase.gsub(/[^A-Z0-9]/, "")
  acc[normalized_key] ||= name
end

normalized_collisions_count = customs_agencies_data.size - normalized_customs_agencies.size
puts "Se omitieron #{normalized_collisions_count} duplicados por normalizacion en agencias" if normalized_collisions_count.positive?

normalized_customs_agencies.values.each do |name|
  entity = Entity.find_by("LOWER(name) = ?", name.downcase) || Entity.new
  entity.name = name
  entity.role_kind = "customs_agent"
  entity.save! if entity.new_record? || entity.changed?
end

puts "✓ Agencias aduanales cargadas: #{normalized_customs_agencies.size}"
...
services_catalog_data = [
  ...
  {
    name: "Coordinación Custodia de Carga General en Almacén",
    applies_to: "bl_house_line",
    code: "BL-COCUS",
    amount: 633.00,
    currency: "MXN",
  ...
  {
    name: "Coordinación Custodia de Carga General en Almacén ATM",
    applies_to: "bl_house_line",
    code: "BL-COCUS-ATM",
    amount: 633.00,
    currency: "MXN",
  ...
  {
    name: "Control Documental y de Información Electrónica de Carga General en Almacén",
    applies_to: "bl_house_line",
    code: "BL-CODIE",
    amount: 754.00,
    currency: "MXN",
  ...
  {
    name: "Control Documental y de Información Electrónica de Carga General en Almacén ATM",
    applies_to: "bl_house_line",
    code: "BL-CODIE-ATM",
    amount: 700.00,
    currency: "MXN",
...
if seed_demo_data
  ...
  # Usuario demo para una agencia aduanal (siempre usa entidad de tipo customs_agent)
  customs_agency_role = Role.find_by(name: Role::CUSTOMS_BROKER)
  customs_agency_entity = Entity.where(role_kind: "customs_agent").order(:name).first
